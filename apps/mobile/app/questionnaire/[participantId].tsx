  ...
  return (
    <Screen>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.kicker}>Cuestionario</Text>
        <Text style={styles.title}>Participante {participantId}</Text>
      </View>

      <View style={styles.card}>
        <View style={styles.iconBox}>
          <ClipboardList color={colors.primary} size={34} strokeWidth={2.1} />
        </View>
        <Text style={styles.cardTitle}>Preferencias y restricciones</Text>
        <Text style={styles.cardText}>
          Esta vista queda preparada para conectar respuestas individuales, límites de presupuesto,
