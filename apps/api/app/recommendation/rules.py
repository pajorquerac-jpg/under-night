...
BASE_TRANSPORT_COSTS: dict[tuple[str, str, str], Decimal] = {
    ...
    ("Ñuñoa", "Centro", "rideshare"): Decimal("4500"),
    ("Ñuñoa", "Oriente", "rideshare"): Decimal("3500"),
    ("Las Condes", "Centro", "rideshare"): Decimal("6500"),
    ("Las Condes", "Oriente", "rideshare"): Decimal("2500"),
    ("Providencia", "Centro", "rideshare"): Decimal("4500"),
    ("Providencia", "Oriente", "rideshare"): Decimal("2500"),
...
BASE_TRAVEL_MINUTES: dict[tuple[str, str], int] = {
    ...
    ("Ñuñoa", "Centro"): 20,
    ("Ñuñoa", "Oriente"): 14,
    ("Las Condes", "Centro"): 30,
    ("Las Condes", "Oriente"): 12,
    ("Providencia", "Centro"): 18,
    ("Providencia", "Oriente"): 10,
    ("Norte", "Centro"): 24,
    ("Norte", "Oriente"): 35,
    ("Sur", "Centro"): 28,
    ("Sur", "Oriente"): 40,
